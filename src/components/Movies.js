...
<div className="row bg-dark"  style={{fontFamily:"Optima"}}>
{movies.map(i=> <Table id={i.id} name ={i.name} img={i.img} genre={i.genre} imbd={i.IMDB_rating} dir={i.info.dir} year={i.info.rel_year}></Table>)} 
</div>    
